...
export function Hero({
  ...
  // Gentle parallax: background moves 30% slower
  ...
  return (
    <section ref={ref} className="relative w-full h-screen flex items-center justify-center overflow-hidden pt-16 bg-gradient-to-br from-gray-950 via-red-950 to-black">
      {/* Animated Gradient Background with Parallax */}
      <motion.div 
        style={{ y: backgroundY }}
        className="absolute inset-0 bg-gradient-to-br from-red-600/30 via-red-700/30 to-red-900/30 animate-pulse-slow" 
      />
